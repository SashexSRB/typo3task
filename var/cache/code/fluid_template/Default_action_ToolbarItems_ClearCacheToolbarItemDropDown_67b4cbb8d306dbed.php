<?php
class Default_action_ToolbarItems_ClearCacheToolbarItemDropDown_67b4cbb8d306dbed extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
'extensionName' => NULL,
'languageKey' => NULL,
'key' => $renderingContext->getViewHelperInvoker()->invoke(TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::class, $arguments14, $renderingContext)
,
];
...
'extensionName' => NULL,
'languageKey' => NULL,
'key' => $renderingContext->getViewHelperInvoker()->invoke(TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::class, $arguments19, $renderingContext)
,
];
